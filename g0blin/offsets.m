...
kern_return_t init_offsets() {
    ...
    // iPhone 5s (iPhone6,2) - iOS 10.3.1 (14E304)
    else if (strcmp(u.machine, "iPhone6,2") == 0 && [os_ver isEqual:@"Version 10.3.1 (Build 14E304)"]) {
        ...
        LOG("loaded offsets for iPhone 5s on 10.3.1");
    }
