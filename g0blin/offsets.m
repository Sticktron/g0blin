...
kern_return_t init_offsets()
{
    ...
    if(!strcmp(device, "iPhone8,4"))
    {
        ...
        if(!strcmp(osversion, "14F5065b"))
        {
            ...
            OFFSET_BZERO                           = 0xfffffff007081f80;
            OFFSET_BCOPY                           = 0xfffffff007081dc0;
            OFFSET_COPYIN                          = 0xfffffff007180604;
            OFFSET_COPYOUT                         = 0xfffffff0071807f8;

            OFFSET_IPC_PORT_ALLOC_SPECIAL          = 0xfffffff007099e3c;
            OFFSET_IPC_KOBJECT_SET                 = 0xfffffff0070ad094;
            OFFSET_IPC_PORT_MAKE_SEND              = 0xfffffff007099960;
            OFFSET_IOSURFACEROOTUSERCLIENT_VTAB    = 0xfffffff006e849f8;
